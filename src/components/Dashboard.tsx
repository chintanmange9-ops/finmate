...
export function Dashboard({ salary }: DashboardProps) {
  const { formatAmount, savingsTarget, getCurrencySymbol } = useAppSettings();
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card className="p-4 bg-gradient-to-r from-green-100 to-blue-100 border-none">
          <div className="text-center">
            <div className="w-8 h-8 mx-auto mb-2 text-green-600 flex items-center justify-center bg-green-200 rounded-full">
