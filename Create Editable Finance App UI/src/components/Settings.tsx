...
export function Settings() {
  ...
  const settingsGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Clear History', icon: Trash2, action: 'clear', danger: true },
  ...
  const handleClearData = () => {
    // Clear all transactions and app data
          ...
          <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Download all your financial data including transactions, settings, and preferences in JSON format.
              </p>
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <Card className="p-4 text-center">
        <p className="text-sm text-gray-600 mb-2">Smart Finance</p>
